...
public class Render3DBaker : Baker<RenderAuth3D>
{
    ...
    {
        if(authoring.transformUsageFlags == TransformUsageFlags.None)
            authoring.transformUsageFlags = TransformUsageFlags.Renderable;
        ...
        AddComponent(thisEntity, new RenderData3D {
